                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input type="text" name="paket_existing[{{ $paket->id }}][lokasi]"
                                                   ...
                                                   placeholder="Contoh: Stasiun Tugu, Malioboro Mall, Hotel XYZ">
                                        ...
                                        <div class="col-12 mb-2">
                                            ...
                                            <input type="text" name="paket_existing[{{ $paket->id }}][destinasi_kunjungi]"
                                                   class="form-control form-control-sm"
                                                   value="{{ old('paket_existing.' . $paket->id . '.destinasi_kunjungi', $paket->destinasi_kunjungi) }}"
                                                   placeholder="Contoh: Pantai Parangtritis, Tebing Breksi, Hutan Pinus">
                                        ...
                                        <div class="col-12 mb-2">
                                            ...
                                            <input type="text" name="paket_existing[{{ $paket->id }}][termasuk]"
                                                   class="form-control form-control-sm"
                                                   value="{{ old('paket_existing.' . $paket->id . '.termasuk', $paket->termasuk) }}"
                                                   placeholder="Contoh: Guide lokal, Snack, Air minum, Tiket masuk">
                                            <small class="text-muted">Pisahkan setiap item dengan koma.</small>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="paket-baru-list">
                                ...
                                <div class="border rounded p-3 mb-3 bg-white" id="paket-baru-row-{{ $oldIdx }}">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm py-0 px-2" onclick="hapusPaketBaruEdit({{ $oldIdx }})">
