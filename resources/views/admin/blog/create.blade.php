        ...
        <div class="col-md-8">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-success text-white py-3">
                    <h5 class="mb-0"><i class="fas fa-newspaper me-2"></i> Tambah Artikel Blog & Informasi</h5>
                </div>
                    ...
                    <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_wisata" class="form-control shadow-none"
                                value="{{ old('nama_wisata') }}" placeholder="Contoh: 10 Tips Wisata Hemat di Jogja" required>
                        </div>

                        <div class="mb-4">
                            <label class="form-label fw-bold">Thumbnail <span class="text-danger">*</span></label>
                            <input type="file" name="gambar1" class="form-control" accept="image/*" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="alamat_lengkap" class="form-control shadow-none"
                                value="{{ old('alamat_lengkap') }}" placeholder="Contoh: Kompas.com" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="url" name="link_sumber" class="form-control shadow-none"
                                value="{{ old('link_sumber') }}" placeholder="https://www.kompas.com/artikel/..." required>
