        ...
        <div class="col-md-8">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-primary text-white py-3">
                    <h5 class="mb-0"><i class="fas fa-plus-circle me-2"></i> Tambah Pamflet Baru</h5>
                </div>
                <div class="card-body p-4">
                    ...
                    <div class="alert alert-danger">
                        ...
                        Maksimal 7 pamflet telah tercapai. Hapus dulu salah satu untuk menambah baru.
                    </div>
                    @endif
                    ...
                    <form action="{{ route('pamflet.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div id="preview-area" class="mb-4 d-none">
                            <label class="form-label fw-bold text-muted">Preview</label><br>
                            <img id="preview-img" src="" style="max-height:200px; border-radius:8px; border:1px solid #dee2e6;">
                        </div>

                        <input type="hidden" name="redirect_to" value="{{ session('admin_back_url', route('pamflet.index')) }}">
                        <div class="d-flex justify-content-end gap-2 pt-3">
                            <a href="{{ session('admin_back_url', route('pamflet.index')) }}" class="btn btn-secondary px-4">Batal</a>
