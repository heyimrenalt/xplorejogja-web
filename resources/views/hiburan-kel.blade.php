...
<head>
    ...
    <title>{{ $category->name ?? 'Hiburan Keluarga' }} - XPloreJogja</title>
...
@include('partials.navbar-static', ['activeCategory' => 'hiburan-kel'])
...
<main class="container mx-auto px-6 py-10 min-h-screen">
    ...
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-cyan-800">{{ $category->name ?? 'Hiburan Keluarga' }}</h1>
