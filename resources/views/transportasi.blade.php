...
<head>
    ...
    <title>{{ $category->name ?? 'Transportasi' }} - XPloreJogja</title>
...
@include('partials.navbar-static', ['activeCategory' => 'transportasi'])
...
<main class="container mx-auto px-6 py-10 min-h-screen">
    ...
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-cyan-800">{{ $category->name ?? 'Transportasi' }}</h1>
